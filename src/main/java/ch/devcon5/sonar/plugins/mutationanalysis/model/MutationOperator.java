...
public final class MutationOperator {
  ...
  MutationOperator(final String id, final String name, final Collection<String> classNames, final String violationDesc, final URL mutagenDescriptionLocation) {
  ...
  /**
   * The ID of the mutagen. The ID is a String that uniquely defines the MutationOperator, written uppercase, like
  ...
  /**
   * A URL pointing to the description of the {@link MutationOperator}. The {@link MutationOperator} descriptions are
   * stored in the classpath as resource, for each {@link MutationOperator} a separate description. The URLs are
   * specified in the {@code mutagen-def.xml} in the classpath. The resources itself are html fragments that can be
  ...
  /**
   * The violation description used for the {@link MutationOperator} specific {@link Rule} that are violated if the
   * mutation caused by the {@link MutationOperator} is not killed.
   *
  ...
  /**
   * The description of the {@link MutationOperator}. The method loads the content defined in the resource that is
   * referred to by the description URL.
   *
