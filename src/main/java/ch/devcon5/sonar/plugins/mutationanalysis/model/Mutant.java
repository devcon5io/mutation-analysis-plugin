...
public class Mutant {
    ...
    *
    * @param builder
    *         the builder containing the parameters for creating the mutant. The parameters have
   ...
   public enum State {
      ...
      // this implementation is a demonstration of the effects of a 'killing spree' on the code
      //
      ...
      public Builder usingMutator(final String mutagenName) {
         ...
         if (mutationOperator == MutationOperators.UNKNOWN) {
            ...
            mutationOperator.getClassNames()
                            ...
                            .findAny()
                            .ifPresent(mutatorClassName -> mutatorSuffix = mutagenName.substring(mutatorClassName.length()));
         } else {
            mutatorSuffix = "";
         }
