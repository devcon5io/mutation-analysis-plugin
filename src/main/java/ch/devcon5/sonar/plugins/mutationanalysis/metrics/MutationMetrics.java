...
public final class MutationMetrics {
  ...
  public static final Metric<Serializable> MUTATIONS_TOTAL = new Metric.Builder(MUTATIONS_TOTAL_KEY, "Mutations: Total", Metric.ValueType.INT)
  ...
  public static final Metric<Serializable> MUTATIONS_TOTAL_PERCENT = new Metric.Builder(MUTATIONS_TOTAL_PERCENT_KEY, "Mutations: Total %", Metric.ValueType.PERCENT)
      .setDirection(DIRECTION_WORST)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
      .setQualitative(true)
  ...
  public static final Metric<Serializable> MUTATIONS_NO_COVERAGE = new Metric.Builder(MUTATIONS_NO_COVERAGE_KEY, "Alive: Not Covered", Metric.ValueType.INT)
      .setDirection(DIRECTION_WORST)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
  ...
  public static final Metric<Serializable> MUTATIONS_DETECTED = new Metric.Builder(MUTATIONS_DETECTED_KEY, "Killed: Total", Metric.ValueType.INT)
      .setDirection(DIRECTION_WORST)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
  ...
  public static final Metric<Serializable> MUTATIONS_ALIVE = new Metric.Builder(MUTATIONS_ALIVE_KEY, "Alive: Total", Metric.ValueType.INT)
      .setDirection(DIRECTION_WORST)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
  ...
  public static final Metric<Serializable> MUTATIONS_KILLED = new Metric.Builder(MUTATIONS_KILLED_KEY, "Killed: by Tests", Metric.ValueType.INT)
      .setDirection(DIRECTION_WORST)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
  ...
  public static final Metric<Serializable> MUTATIONS_UNKNOWN = new Metric.Builder(MUTATIONS_UNKNOWN_KEY, "Unknown Status", Metric.ValueType.INT)
      .setDirection(DIRECTION_WORST)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
  ...
  public static final Metric<Serializable> MUTATIONS_COVERAGE = new Metric.Builder(MUTATIONS_COVERAGE_KEY, "Mutation: Coverage", Metric.ValueType.PERCENT)
  ...
  public static final Metric<Serializable> MUTATIONS_ALIVE_PERCENT = new Metric.Builder(MUTATIONS_ALIVE_PERCENT_KEY, "Alive: Total %", Metric.ValueType.PERCENT)
      .setDirection(DIRECTION_WORST)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
      .setQualitative(true)
      .setDescription("Distribution Percentage of all survivors")
      .setBestValue(0.)
      .setWorstValue(100.)
      .setDecimalScale(1)
      .create();
  ...
  public static final Metric<Serializable> MUTATIONS_TIMED_OUT = new Metric.Builder(MUTATIONS_TIMED_OUT_KEY, "Killed: by Timeout", Metric.ValueType.INT)
      .setDirection(DIRECTION_WORST)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
  ...
  public static final Metric<Serializable> MUTATIONS_MEMORY_ERROR = new Metric.Builder(MUTATIONS_MEMORY_ERROR_KEY, "Killed: by Memory Error", Metric.ValueType.INT)
      .setDirection(DIRECTION_WORST)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
  ...
  public static final Metric<Serializable> MUTATIONS_SURVIVED = new Metric.Builder(MUTATIONS_SURVIVED_KEY, "Alive: Survivors", Metric.ValueType.INT)
      .setDirection(DIRECTION_WORST)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
  ...
  public static final Metric<Serializable> TEST_KILLS = new Metric.Builder(TEST_KILLS_KEY, "Test: Kills", Metric.ValueType.INT)
      .setDirection(DIRECTION_WORST)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
  ...
  public static final Metric<Serializable> UTILITY_GLOBAL_MUTATIONS = new Metric.Builder(UTILITY_GLOBAL_MUTATIONS_KEY, "Utility: Total Mutations Global", Metric.ValueType.INT)
      .setDirection(DIRECTION_BETTER)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
  ...
  public static final Metric<Serializable> UTILITY_GLOBAL_ALIVE = new Metric.Builder(UTILITY_GLOBAL_ALIVE_KEY, "Utility: Total Survivors Global", Metric.ValueType.INT)
      .setDirection(DIRECTION_BETTER)
      .setDomain(MUTATION_ANALYSIS_DOMAIN)
  ...
  static {
    final List<Metric<Serializable>> metrics = new ArrayList<>(
        QUALITATIVE_METRICS.size() + QUANTITATIVE_METRICS.size());
