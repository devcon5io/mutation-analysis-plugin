...
public final class MutationMetrics {
    ...
    public static final Metric<Serializable> UTILITY_GLOBAL_MUTATIONS=new Metric.Builder(UTILITY_GLOBAL_MUTATIONS_KEY, "Utility: Total Mutations Global", Metric
        .ValueType
        .INT)
        .setDirection(DIRECTION_BETTER)
        .setDomain(MUTATION_ANALYSIS_DOMAIN)
